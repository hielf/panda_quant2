    ...
    json.array! @recommends.group_by{ |c| c.recommend_date } do |re|
      ...
      json.stocks do
        json.array! re[1] do |stock|
          ...
          json.column_4 "三日涨跌幅"
          json.value_4 quote_change(stock.recommend_price, stock.current_price)
          json.img_url "http://image.sinajs.cn/newchart/daily/n/#{stock_code_trans(stock.stock_code[0..5])}.gif"
        end
      end
    end
  end
